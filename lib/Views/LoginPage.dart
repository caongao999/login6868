...
import 'package:S_Booking_Demo/Views/ForgotPassPage.dart';
import 'package:S_Booking_Demo/Views/App.dart';
import 'package:S_Booking_Demo/Views/RegisterPage.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  //
  //     try {
  //       bool isAuthenticated = await authenticate(data);
  //
  //       if (isAuthenticated) {
  ...
  //     // Xử lý khi email hoặc password trống
  //     print('Vui lòng điền đầy đủ thông tin đăng nhập');
  //     return;
  //   }
  //
  //   ModelLogin model = ModelLogin(email: email, password: password);
